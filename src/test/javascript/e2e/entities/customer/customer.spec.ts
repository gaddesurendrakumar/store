  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.setEmailInput(
        't:mH3/ZF^*N7.O2wN:&lt;Ir+f*@Nh;iodJx7_[d)OCM_B!W.^$OXey^PKxG-W9qkfJ=4Cc{&lt;6e+KVF138RR1.!eCWz_uq&lt;a:aH_C7q4:2-Dqz6lg6FLf&lt;*|Q)X-&#39;K&gt;5q)_v;p$f(ES51A&amp;2#*t4CbSLT]~)bz63uyFjv/+Z{t/0D!vkxdYN.0-Ty'
      ),
    ...
    expect(await customerUpdatePage.getEmailInput()).to.eq(
      't:mH3/ZF^*N7.O2wN:&lt;Ir+f*@Nh;iodJx7_[d)OCM_B!W.^$OXey^PKxG-W9qkfJ=4Cc{&lt;6e+KVF138RR1.!eCWz_uq&lt;a:aH_C7q4:2-Dqz6lg6FLf&lt;*|Q)X-&#39;K&gt;5q)_v;p$f(ES51A&amp;2#*t4CbSLT]~)bz63uyFjv/+Z{t/0D!vkxdYN.0-Ty',
      'Expected Email value to be equals to t:mH3/ZF^*N7.O2wN:&lt;Ir+f*@Nh;iodJx7_[d)OCM_B!W.^$OXey^PKxG-W9qkfJ=4Cc{&lt;6e+KVF138RR1.!eCWz_uq&lt;a:aH_C7q4:2-Dqz6lg6FLf&lt;*|Q)X-&#39;K&gt;5q)_v;p$f(ES51A&amp;2#*t4CbSLT]~)bz63uyFjv/+Z{t/0D!vkxdYN.0-Ty'
    );
