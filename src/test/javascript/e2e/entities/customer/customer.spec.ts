...
describe('Customer e2e test', () => {
  ...
  /*  it('should create and save Customers', async () => {
        ...
        await promise.all([
            ...
            customerUpdatePage.setEmailInput('e[JviL~RAvc?w%M9P}yiIK\+;l0{p&amp;eMk1pq&#39;RpnOu7vO~yTS.UW[dRc4IZPs?7K)s|(erbC\@fe&#39;wumUBR:y.fS^?,%7a~I&lt;1,1KkZc'),
        ...
        expect(await customerUpdatePage.getEmailInput()).to.eq('e[JviL~RAvc?w%M9P}yiIK\+;l0{p&amp;eMk1pq&#39;RpnOu7vO~yTS.UW[dRc4IZPs?7K)s|(erbC\@fe&#39;wumUBR:y.fS^?,%7a~I&lt;1,1KkZc', 'Expected Email value to be equals to e[JviL~RAvc?w%M9P}yiIK\+;l0{p&amp;eMk1pq&#39;RpnOu7vO~yTS.UW[dRc4IZPs?7K)s|(erbC\@fe&#39;wumUBR:y.fS^?,%7a~I&lt;1,1KkZc');
